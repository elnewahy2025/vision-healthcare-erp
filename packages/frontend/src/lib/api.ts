...
export const financialApi = {
  revenue: (params?: { period?: string }) =>
    api.get('/billing/revenue', { params }).then((r) => r.data.data as RevenueSummary),
  revenueByMonth: (year?: number) =>
    api.get('/billing/revenue/monthly', { params: { year } }).then((r) => r.data.data as PlMonthData[]),
  aging: () =>
    api.get('/billing/reports/aging').then((r) => r.data.data as AgingBucket[]),
  topPatients: () =>
    api.get('/billing/reports/top-patients').then((r) => r.data.data as TopPatient[]),
  plReport: (params: { from: string; to: string }) =>
    api.get('/financial/pl-report', { params }).then((r) => r.data.data as PlReport),
  ...
  createExpense: (data: CreateExpensePayload) =>
    api.post('/expenses', data).then((r) => r.data.data as ExpenseItem),
  updateExpense: (id: string, data: Partial<CreateExpensePayload>) =>
    api.put(`/expenses/${id}`, data).then((r) => r.data.data),
  approveExpense: (id: string) =>
    api.put(`/expenses/${id}/approve`, {}).then((r) => r.data.data),
  listBudgetPlans: () =>
    api.get('/budget-plans').then((r) => r.data.data as BudgetPlan[]),
  createBudgetPlan: (data: CreateBudgetPlanPayload) =>
    api.post('/budget-plans', data).then((r) => r.data.data as BudgetPlan),
};
...
export const whiteLabelApi = {
  getBranding: () =>
    api.get('/white-label/branding').then((r) => r.data.data as TenantBranding),
  updateBranding: (data: UpdateBrandingPayload) =>
    api.put('/white-label/branding', data).then((r) => r.data.data),
  listDomains: () =>
    api.get('/white-label/domains').then((r) => r.data.data as TenantDomain[]),
  addDomain: (data: AddDomainPayload) =>
    api.post('/white-label/domains', data).then((r) => r.data.data),
  verifyDomain: (id: string) =>
    api.post(`/white-label/domains/${id}/verify`).then((r) => r.data.data),
  deleteDomain: (id: string) =>
    api.delete(`/white-label/domains/${id}`).then((r) => r.data.data),
  getSettings: () =>
    api.get('/white-label/settings').then((r) => r.data.data),
};
...
export const saasApi = {
  listPlans: () =>
    api.get('/saas/plans').then((r) => r.data.data as SubscriptionPlan[]),
  getSubscription: () =>
    api.get('/saas/subscription').then((r) => r.data.data as TenantSubscription | null),
  createSubscription: (data: CreateSubscriptionPayload) =>
    api.post('/saas/subscription', data).then((r) => r.data.data),
  changePlan: (data: ChangePlanPayload) =>
    api.put('/saas/subscription/plan', data).then((r) => r.data.data),
  cancelSubscription: () =>
    api.post('/saas/subscription/cancel').then((r) => r.data.data),
  getUsage: (params?: { metric?: string; days?: number }) =>
    api.get('/saas/usage', { params }).then((r) => r.data.data as SaasUsageData),
  listInvoices: () =>
    api.get('/saas/invoices').then((r) => r.data.data as SaasInvoice[]),
};
...
export const integrationsApi = {
  listCatalog: () =>
    api.get('/integrations/catalog').then((r) => r.data.data as IntegrationCatalogItem[]),
  listConnections: () =>
    api.get('/integrations/connections').then((r) => r.data.data as IntegrationConnection[]),
  createConnection: (data: CreateConnectionPayload) =>
    api.post('/integrations/connections', data).then((r) => r.data.data),
  updateConnection: (id: string, data: Partial<CreateConnectionPayload>) =>
    api.put(`/integrations/connections/${id}`, data).then((r) => r.data.data),
  testConnection: (id: string) =>
    api.post(`/integrations/connections/${id}/test`).then((r) => r.data.data),
  deleteConnection: (id: string) =>
    api.delete(`/integrations/connections/${id}`).then((r) => r.data.data),
  listWebhooks: () =>
    api.get('/integrations/webhooks').then((r) => r.data.data as IntegrationWebhook[]),
  createWebhook: (data: CreateWebhookPayload) =>
    api.post('/integrations/webhooks', data).then((r) => r.data.data),
  updateWebhook: (id: string, data: Partial<CreateWebhookPayload>) =>
    api.put(`/integrations/webhooks/${id}`, data).then((r) => r.data.data),
  listWebhookLogs: (webhookId: string) =>
    api.get(`/integrations/webhooks/${webhookId}/logs`).then((r) => r.data.data as WebhookLog[]),
};
...
export const complianceApi = {
  // Compliance module (policies, audits, consents, breaches)
  ...
  listReports: (params?: { type?: string; status?: string }) =>
    api.get('/compliance/reports', { params }).then((r) => r.data.data as ComplianceReport[]),
  createReport: (data: CreateComplianceReportPayload) =>
    api.post('/compliance/reports', data).then((r) => r.data.data),
  updateReport: (id: string, data: Partial<ComplianceReport>) =>
    api.put(`/compliance/reports/${id}`, data).then((r) => r.data.data),

  // HIPAA Audit
  hipaaAudit: (params?: { entity?: string; days?: number; userId?: string }) =>
    api.get('/compliance/hipaa-audit', { params }).then((r) => r.data.data as HipaaAuditLog[]),
  hipaaSummary: (params?: { days?: number }) =>
    api.get('/compliance/hipaa-summary', { params }).then((r) => r.data.data as HipaaSummary),

  // Retention Policies
  listRetentionPolicies: () =>
    api.get('/compliance/retention-policies').then((r) => r.data.data as RetentionPolicy[]),
  createRetentionPolicy: (data: { entity: string; retentionDays?: number; action?: string; isActive?: boolean }) =>
    api.post('/compliance/retention-policies', data).then((r) => r.data.data),
  updateRetentionPolicy: (id: string, data: Partial<RetentionPolicy>) =>
    api.put(`/compliance/retention-policies/${id}`, data).then((r) => r.data.data),

  // BAA
  listBaas: () =>
    api.get('/compliance/baa').then((r) => r.data.data as Baa[]),
  createBaa: (data: CreateBaaPayload) =>
    api.post('/compliance/baa', data).then((r) => r.data.data),
  updateBaa: (id: string, data: Partial<Baa>) =>
    api.put(`/compliance/baa/${id}`, data).then((r) => r.data.data),
};
