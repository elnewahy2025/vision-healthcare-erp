          ...
          {filteredDashboards.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              {filteredDashboards.map((d) => (
                <div
                  key={d.id}
                  className={`bg-[var(--surface)] rounded-lg border p-4 dark:bg-[var(--background)] dark:border-gray-800 cursor-pointer transition-all hover:shadow-md ${
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-3 text-xs text-[var(--text-disabled)]">
                    <span>
          ...
          {selectedDashboard && (
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {widgets.map((w) => (
                  <div key={w.id} className="bg-[var(--surface)] rounded-lg border p-4 dark:bg-[var(--background)] dark:border-gray-800">
                    <div className="flex items-center justify-between mb-2">
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-[var(--surface)] rounded-lg border p-4 dark:bg-[var(--background)] dark:border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-[var(--text-muted)]">{t('bi.appointments')}</p>
            ...
            <div className="bg-[var(--surface)] rounded-lg border p-4 dark:bg-[var(--background)] dark:border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-[var(--text-muted)]">{t('bi.revenue')}</p>
                  <p className="text-xl font-bold">
            ...
            <div className="bg-[var(--surface)] rounded-lg border p-4 dark:bg-[var(--background)] dark:border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-[var(--text-muted)]">{t('bi.patients')}</p>
                  <p className="text-xl font-bold">
            ...
            <div className="bg-[var(--surface)] rounded-lg border p-4 dark:bg-[var(--background)] dark:border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-[var(--text-muted)]">{t('bi.clinical')}</p>
                  <p className="text-xl font-bold">
          ...
          <div className="bg-[var(--surface)] rounded-lg border p-4 dark:bg-[var(--background)] dark:border-gray-800">
            ...
            {(kpiAppointments?.byStatus ?? []).length > 0 ? (
              ...
              <p className="text-sm text-[var(--text-muted)]">{t('bi.noAppointmentData')}</p>
            )}
          </div>
        </div>
      )}
