          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <Card><CardBody>
              <div className="flex items-center gap-3">
                ...
                <div><p className="text-xs text-gray-500">Revenue</p><p className="text-xl font-bold">{Number(kpiData.revenue?.total || 0).toFixed(0)} SAR</p></div>
              </div>
              <p className="text-xs text-gray-400 mt-2">{Number(kpiData.revenue?.recent || 0).toFixed(0)} SAR (30d)</p>
            </CardBody></Card>
            <Card><CardBody>
              <div className="flex items-center gap-3">
