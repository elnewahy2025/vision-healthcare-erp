...
export async function up(knex: Knex): Promise<void> {
  // Online Booking
  if (!(await knex.schema.hasTable('booking_slots'))) {
  ...
  if (!(await knex.schema.hasTable('booking_requests'))) {
  ...
  if (!(await knex.schema.hasTable('patient_messages'))) {
  ...
  if (!(await knex.schema.hasTable('telemedicine_waiting_room'))) {
  ...
  if (!(await knex.schema.hasTable('telemedicine_chat_messages'))) {
