...
export async function up(knex: Knex): Promise<void> {
  // ── Laboratory ──
  if (!(await knex.schema.hasTable('lab_orders'))) {
  ...
  if (!(await knex.schema.hasTable('lab_catalog'))) {
  ...
  // ── Radiology ──
  if (!(await knex.schema.hasTable('radiology_orders'))) {
  ...
  // ── Pharmacy ──
  if (!(await knex.schema.hasTable('pharmacy_prescriptions'))) {
  ...
  if (!(await knex.schema.hasTable('pharmacy_prescription_items'))) {
  ...
  // ── Queue Management ──
  if (!(await knex.schema.hasTable('queue_entries'))) {
  ...
  // ── Nursing ──
  if (!(await knex.schema.hasTable('nursing_tasks'))) {
  ...
  if (!(await knex.schema.hasTable('nursing_notes'))) {
  ...
  // ── Home Visits ──
  if (!(await knex.schema.hasTable('home_visits'))) {
  ...
  // ── Telemedicine ──
  if (!(await knex.schema.hasTable('telemedicine_sessions'))) {
