...
export async function up(knex: Knex): Promise<void> {
  ...
  if (!(await knex.schema.hasTable('insurance_companies'))) {
  ...
  if (!(await knex.schema.hasTable('insurance_claims'))) {
  ...
  if (!(await knex.schema.hasTable('payroll_entries'))) {
  ...
  // ── CRM ──
  if (!(await knex.schema.hasTable('crm_campaigns'))) {
  ...
  if (!(await knex.schema.hasTable('crm_patient_feedback'))) {
  ...
  // ── Form Builder ──
  if (!(await knex.schema.hasTable('form_definitions'))) {
  ...
  if (!(await knex.schema.hasTable('form_submissions'))) {
  ...
  // ── Compliance Center ──
  if (!(await knex.schema.hasTable('compliance_policies'))) {
  ...
  if (!(await knex.schema.hasTable('compliance_audits'))) {
  ...
  if (!(await knex.schema.hasTable('data_consent_logs'))) {
  ...
  if (!(await knex.schema.hasTable('breach_log'))) {
