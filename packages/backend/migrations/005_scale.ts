...
export async function up(knex: Knex): Promise<void> {
  ...
  if (!(await knex.schema.hasTable('tenant_subscriptions'))) {
  ...
  if (!(await knex.schema.hasTable('usage_records'))) {
  ...
  if (!(await knex.schema.hasTable('subscription_invoices'))) {
  ...
  if (!(await knex.schema.hasTable('tenant_branding'))) {
  ...
  if (!(await knex.schema.hasTable('business_associate_agreements'))) {
  ...
  if (!(await knex.schema.hasTable('backup_configs'))) {
  ...
  if (!(await knex.schema.hasTable('backup_executions'))) {
  ...
  if (!(await knex.schema.hasTable('dr_configs'))) {
  ...
  if (!(await knex.schema.hasTable('tenant_data_residency'))) {
